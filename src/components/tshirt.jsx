...
export default function GamePlane() {
    ...
    const links = dd.length>0 && dd[0].link
    ...
    return (
        <div className="mt-[60px] w-[100%] h-auto min-h-[calc(100vh-17px)] flex flex-col justify-center items-center">
            ...
            {image != '' ? <div className="w-[95%] max-w-[800px] h-auto relative z-[4] flex items-center jutify-center mt-[15px]">
                <div className="absolute z-[8] top-[20px] right-[20px] flex flex-col">
                    ...
                    <a className="w-[170px] h-[30px] mt-[10px] flex rounded-lg items-center justify-center bg-slate-200 text-[15px] font-[400] text-sky-800 shadow-lg shadow-sky-700 hover:scale-[1.1] hover:duration-[0.3s] duration-[0.3s]" href={links} target="blank">Order Now<i className="ml-[10px] fa-solid fa-cart-shopping"></i></a>
                </div>
